...
public final class AlchemistNetworkManager implements NetworkManager, Serializable {
    ...
    private LinkedHashMap<DeviceUID, MessageInfo> messages = new LinkedHashMap<>();
    ...
    public Map<DeviceUID, Map<CodePath, Object>> getNeighborState() {
        ...
        if (timeAtLastValidityCheck != currentTime) {
            if (messages.isEmpty()) {
                ...
                final Iterator<MessageInfo> messages = this.messages.values().iterator();
                ...
                while (messages.hasNext()) {
                    final MessageInfo message = messages.next();
