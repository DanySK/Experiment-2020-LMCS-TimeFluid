...
//
//    private <T, V, E> E alignedExecution(
//        final ExecutionContext context,
//        final FunctionDefinition ebeOperation,
//        final BiFunction<Stream<T>, Function<T , V> bulkOperation) {
//        if (Objects.requireNonNull(ebeOperation).getParameterCount() == 1 || ebeOperation.invokerShouldInitializeIt()) {
//            final AtomicInteger counter = new AtomicInteger();
//            return bulkOperation(
//                Arrays.stream(arrayContents),
//                elem -> {
//                    final List<ProtelisAST<?>> arguments = elementAsArguments(elem);
//                    final FunctionCall fc = new FunctionCall(JavaInteroperabilityUtils.METADATA, ebeOperation, arguments);
//                    final Object outcome = context.runInNewStackFrame(counter.getAndIncrement(), fc::eval);
//                    if (outcome instanceof Boolean) {
//                        return (Boolean) outcome;
//                    } else {
//                        throw new IllegalArgumentException("Filtering functions must return boolean.");
